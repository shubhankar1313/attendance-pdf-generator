...
def generate_pdf(data):
    ...
    pdf.add_text("")
    pdf.add_text(f"We are writing to kindly request your permission to be marked present for the duration of {data['start_time']} to {data['end_time']} on {data['event_name']}. During this time, we will be actively participating in the {data['event_name']} organized by Megapixels.", '', 'm', 'J')
    pdf.add_text("")
    ...
    pdf.add_text("")
    pdf.add_text(f"{data['event_name']} | {data['start_time']} - {data['end_time']} | {data['event_date']}", 'b')
    pdf.add_text("")
